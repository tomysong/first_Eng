...
### 완료된 확장 (2026-06-11)
- **로그인 없는 다중 프로필**: 한 기기에서 `＋ 친구 추가`로 사용자 전환. 프로필별 localStorage 네임스페이스(`kidEnglish.<id>.*`), 첫 프로필 "나"는 기존 키를 이어받아 데이터 마이그레이션 불필요. AI 키·목소리는 기기 공통. 기기 간 동기화가 필요할 때만 서버 로그인 도입.
