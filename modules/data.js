...
export const curriculumSeeds = {
  starter: [
    ...
    ["Weather talk", "날씨와 하고 싶은 일 말하기", "It is sunny, so I want to play outside."],
    ["Favorite color", "좋아하는 색과 물건 말하기", "My favorite color is blue. I have a blue bottle."],
    ["Family count", "가족 구성원을 소개하기", "There are four people in my family."],
    ["School subjects", "오늘 과목과 선호 말하기", "I have math and music today."],
    ["Morning routine", "아침에 하는 일 말하기", "I wash my face and eat breakfast."],
    ["Food choices", "좋아하는 음식 재료 말하기", "I like pizza with cheese and tomatoes."],
    ["After school", "방과 후 활동 말하기", "After school, I do homework and play."],
    ["My hobby", "취미를 한 문장 더 설명하기", "I like drawing pictures of flowers."],
    ["Invite a friend", "친구에게 같이 하자고 말하기", "Do you want to play with me?"],
    ["Game talk", "게임 취향을 묻고 답하기", "My favorite game is a soccer game."],
    ["At the park", "공원에서 하고 싶은 일 말하기", "I want to ride my bike in the park."],
    ["Birthday plan", "생일에 하고 싶은 일 말하기", "I want to eat cake with my friends."],
    ["My week", "이번 주 한 일을 간단히 말하기", "This week, I studied English every day."],
    ["Ask me", "친구에게 질문하기", "What do you like to do after school?"],
    ["Compare favorites", "두 가지 중 더 좋아하는 것 말하기", "I like music more than math."],
    ["Need help", "모를 때 도움 요청하기", "Can you help me, please?"],
    ["Show and tell", "내 물건을 소개하기", "This is my pencil case. It is special."],
    ["Mini speech", "배운 표현으로 짧게 발표하기", "Let me tell you about my favorite things."],
  ],
  a1: [
    ...
    ["After school", "방과 후 루틴을 자세히 말하기", "I usually do my homework first."],
    ["Last weekend", "지난 주말 경험 말하기", "Last weekend, I went to the zoo."],
    ["Best friend", "친구 성격과 함께 하는 일 말하기", "My best friend is kind and funny."],
    ["Sports practice", "연습과 성장 말하기", "I am getting better at basketball."],
    ["Birthday party", "파티 계획을 미래형으로 말하기", "We will eat cake and play games."],
    ["Shopping", "가게에서 찾는 물건 말하기", "I am looking for a blue cap."],
    ["Dream job", "장래희망과 이유 말하기", "I want to be a doctor because I want to help people."],
    ["Travel memory", "여행 경험과 좋았던 점 말하기", "I went to Jeju Island and liked the beach."],
    ["Class survey", "친구에게 질문하고 답 정리하기", "Most students like music because it is fun."],
    ["Phone call", "전화로 약속 정하기", "Can you come to my house this Saturday?"],
    ["Lost item", "잃어버린 물건 설명하기", "I lost my pencil case. It is small and green."],
    ["Restaurant order", "식당에서 주문하고 추가 요청하기", "I would like noodles and some water, please."],
    ["My opinion", "간단한 의견과 이유 말하기", "I think homework is useful because I can practice."],
    ["Compare activities", "활동 두 가지 비교하기", "Reading is quieter than playing soccer."],
    ["Give advice", "친구에게 조언하기", "You should rest and drink warm water."],
    ["Story order", "일어난 일을 순서대로 말하기", "First we met, then we played, and finally we ate."],
    ["Team project", "역할을 나누어 말하기", "I will draw pictures, and you can write the title."],
    ["Mini interview", "질문 3개를 이어서 주고받기", "What do you usually do after school?"],
  ],
  a1plus: [
    ...
    ["School news", "학교 소식을 듣고 의견 말하기", "I think it is a great idea for everyone."],
    ["Environment", "환경 보호 방법 제안하기", "We should recycle and save water."],
    ["Future tech", "미래 기술을 상상해 말하기", "I think robots will help us at home."],
    ["Book review", "책을 추천하고 이유 말하기", "You should read this book because it is touching."],
    ["Culture talk", "한국 학교생활을 소개하기", "We take off our shoes inside school."],
    ["Uniform debate", "찬반 의견을 부드럽게 말하기", "That's true, but uniforms save time."],
    ["Perfect day", "상상 속 하루를 묘사하기", "On my perfect day, I would sleep late."],
    ["Friend advice", "친구 고민에 조언하기", "If I were you, I would talk to the teacher."],
    ["News summary", "짧은 소식을 요약하기", "The main idea is that our school will change."],
    ["Agree or disagree", "동의·반대와 이유 말하기", "I agree because it helps many students."],
    ["Plan a trip", "여행 계획을 조건과 함께 말하기", "If it is sunny, we can visit the beach."],
    ["Explain rules", "게임이나 활동 규칙 설명하기", "You have to listen first, then answer quickly."],
    ["Persuade a friend", "친구를 설득하기", "You should try it because it is easier than it looks."],
    ["Compare cultures", "두 문화의 차이를 비교하기", "In Korea, we bow, but in some countries people shake hands."],
    ["Tell a memory", "기억에 남는 일을 감정과 함께 말하기", "I felt proud because I finished the project."],
    ["Solve together", "협동해서 문제 해결 말하기", "Let's split the work and check it together."],
    ["Mini presentation", "90초 발표의 시작·중간·끝 만들기", "Today I will talk about my favorite hobby."],
    ["Final interview", "질문을 듣고 길게 답하기", "In my opinion, English is useful because I can meet more people."],
  ],
};
